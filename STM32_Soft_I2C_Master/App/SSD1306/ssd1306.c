...
{
    Soft_I2C_Master_Transmit(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x00, 1, &command, 1);
    while(Soft_I2C1.Active_Flag);

    if(Soft_I2C_Master_Get_Status(&SSD1306_I2C_PORT) == I2C_Error)
	{
	while(1);
	}
}
...
void ssd1306_UpdateScreen(void) 
{
	...
	for (i = 0; i < 8; i++) {
		...
		Soft_I2C_Master_Transmit(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x40, 1, &SSD1306_Buffer[SSD1306_WIDTH * i], SSD1306_WIDTH);
	        while(Soft_I2C1.Active_Flag);
	}
