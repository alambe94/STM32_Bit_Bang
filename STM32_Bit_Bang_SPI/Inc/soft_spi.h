...
void Soft_SPI_Send_Bytes(Soft_SPI_t* uart_handle, uint8_t* tx_buffer, uint16_t len);
void Soft_SPI_Receive_Bytes(Soft_SPI_t* uart_handle, uint8_t* rx_buffer, uint16_t len);
